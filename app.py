...
min_rise = st.sidebar.slider("最小漲幅 (%)", 0, 50, 30, help="降低此值以獲得更多結果")
max_range = st.sidebar.slider("最大盤整範圍 (%)", 3, 15, 5, help="增加此值以放寬整理區間")
min_adr = st.sidebar.slider("最小 ADR (%)", 0, 10, 5, help="降低此值以納入更多股票")
